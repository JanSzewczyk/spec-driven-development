...
description: Detects drift between the documentation (spec.md, plan.md, tasks.md) and the current code state. Invoked by /review and /analyze. Returns a list of concrete conflicts with file paths and line numbers.
